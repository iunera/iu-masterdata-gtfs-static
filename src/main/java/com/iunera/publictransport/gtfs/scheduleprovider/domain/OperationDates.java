...
import com.iunera.publictransport.gtfs.scheduleprovider.queryresultmodels.SpecialTrip;
import java.util.List;

public class OperationDates {

  public List<RegularTrip> additionalTrips;
  public List<SpecialTrip> removedTrips;
  public List<RegularTrip> regulartrips;
}
